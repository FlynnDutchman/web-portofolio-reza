...
@@ -50,14 +46,12 @@ export default function Portfolio() {
</motion.div>
)}
...
@@ -71,19 +65,14 @@ export default function Portfolio() {
</div>
</div>
...
@@ -99,7 +88,6 @@ export default function Portfolio() {
</div>
</nav>
...
@@ -126,170 +114,90 @@ export default function Portfolio() {
